...
<template>
    <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
        <button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden" @click="$emit('openSidebar')">
            ...
            <i-heroicons-outline-bars3 class="h-6 w-6" aria-hidden="true"/>
        </button>
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form class="relative flex flex-1" action="#" method="GET">
                ...
                <input id="search-field"
                       ...
                       :placeholder="$t('test')" type="search" name="search"/>
            </form>
            <div class="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <Menu as="div" class="relative">
                  ...
                  <i-heroicons-outline-chevron-down class="ml-2 h-5 w-5 text-gray-400" aria-hidden="true"/>
                </span>
                    </MenuButton>
